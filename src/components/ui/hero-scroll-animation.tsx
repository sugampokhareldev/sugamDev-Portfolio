...
//     at the call site instead: <Component client:visible />. Without a
//     client:* directive this renders as static HTML and no scroll animation
//     will run.
//   - Every class name here is Tailwind. Tailwind is NOT installed in this
//     project (see the setup notes in the integration summary); until it is,
//     this component renders as unstyled markup.
'use client';
