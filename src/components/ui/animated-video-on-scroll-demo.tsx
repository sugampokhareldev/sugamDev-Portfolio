// demo.tsx
//
// Upstream imports these from `@/components/blocks/...`. This project's
// shadcn alias for primitives is `@/components/ui` (components.json), so the
// path is normalised here — there is no `blocks` directory.
import {
  ContainerAnimated,
  ContainerInset,
  ContainerScroll,
